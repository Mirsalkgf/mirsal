...
const array = ['Pinky','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','uff','umma','Vaa','vada','yo','Good night'.'good night','Converting','converting','ABHI BGM','Abhi','chunk','MADHAVAN BGM','MADHAVAN','marco','MIRSAL','Mirsal bgm','mirsal mass','myre','njr','sed life','SONG','suyra','VINAYAK MASS','VINAYAK','vkml']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
